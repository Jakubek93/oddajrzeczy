      ...
      <ItemContainer>
        {items.map((item) => (
          <ItemCard key={item.id}>
            {item.image_url && (
              <ImageContainer>
                {imageLoadStatus[item.id] !== "loaded" && (
                  <div>Ładowanie obrazu...</div>
                )}
                <ItemImage
                  src={item.image_url}
                  alt={item.name}
                  ...
                  style={{
                    display:
                      imageLoadStatus[item.id] === "loaded" ? "block" : "none",
                  }}
                />
                {imageLoadStatus[item.id] === "error" && (
                  <div>Nie udało się załadować obrazu</div>
                )}
              </ImageContainer>
            )}
            <ItemName>{item.name}</ItemName>
